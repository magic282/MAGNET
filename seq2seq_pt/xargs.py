...
def add_model_options(parser: argparse.ArgumentParser):
    ...
    parser.add_argument('-eq_lambda', required=True, type=float)
    parser.add_argument('-loss_normalize', action="store_true")
